...
const PhysicsDepartment = () => {
  ...
  const outcomes = [
    'Develop a strong foundation in Physics concepts and theories',
    'Apply analytical and problem-solving skills to real-world scenarios',
    'Prepare for higher education and research in Physics',
    'Build professional competencies for industry and academia',
  ];

  return (
    <AcademicsLayout pageTitle="Department of Physics" breadcrumbPath="Physics" category="Departments">
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-5 text-muted-foreground leading-relaxed text-base md:text-lg">
            <p>The Department of Physics at National College is committed to providing quality education and fostering academic excellence. The department offers comprehensive programs designed to equip students with both theoretical knowledge and practical skills.</p>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="text-muted-foreground leading-relaxed text-base md:text-lg">
            <p>Welcome to the Department of Physics. We are dedicated to nurturing academic excellence and preparing our students for successful careers and further studies in Physics.</p>
          </div>
        </div>
      </section>
